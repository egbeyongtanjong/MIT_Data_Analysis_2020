...
When we talk about big O notation we are not really intersted in some small input
the idea is to predict the worse case scenario of big inputs

Big O tells you steps. True time complexity depends on cpu speed
and many other factors

Big O on the hand gives you and idea of how the speed grows relatively
to the size the input
